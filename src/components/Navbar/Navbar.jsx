...
import { ShoppingCart, Phone, ChevronDown } from "lucide-react";
            ...
            <Container>
                ...
                >
                                ...
                                <li key={link.label}>
                                    <Link
                                        ...
                                        className={
                                            ...
                                            (isActive ? "text-white" : "text-[#c3bdac] hover:text-white")
                                        }
                                    >
                                        {link.label}
                                        <span
                        ...
                        >
                            <div
                                className={
                                    ...
                                    (isServicesActive || servicesOpen ? "text-white" : "text-[#c3bdac] hover:text-white")
                                }
                            >
                    ...
                    <div className="hidden items-center gap-5 lg:flex">
                        ...
                        >
                            <Phone size={18} strokeWidth={1.75} className="transition-transform duration-400 group-hover:rotate-12" />
                            <p>+880 1961-727320</p>
                        </a>
                        <Link
                            to="/booking"
                    ...
                    <div className="overflow-hidden">
                        <ul className="flex flex-col gap-1 border-t border-primary/20 py-4 text-sm font-medium text-[#c3bdac]">
                            ...
                            >
                                ...
                                >
                                    <Link to="/services" onClick={closeMenu} className="flex-1">
                                        Services
                                    </Link>
                                    <button
                                        type="button"
