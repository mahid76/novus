...
const reviews = [
  ...
  {
    quote:
      "Company incorporation and RJSC compliance that used to take weeks was sorted in days. Novus Tax kept us informed at every step.",
    name: "Rakibul Hasan",
        ...
        >
          ...
          <div key={index} className="min-h-[96px] animate-fade-up">
            ...
            <div className="text-ink-dim text-[14px] mt-6">
              <b className="text-ink">{reviews[index].name}</b> — {reviews[index].role}
            </div>
          </div>
