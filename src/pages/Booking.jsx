                ...
                <Container>
                    ...
                    >
                        ...
                        <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-ink-dim">
                            Tell us a bit about your requirement — an advisor from the
                            right division will reach out to confirm your session.
                        </p>
                    </div>
                </Container>
            </div>
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <p className="mt-3 text-[12.5px] text-muted">
                                This opens WhatsApp with your booking details pre-filled —
                                just hit send.
                            </p>
                        </form>
