...
const WHATSAPP_NUMBER = "8801886811862"; // international format, no "+" or leading zeros
...
--------------------------------------------------------- */
const EMAILJS_SERVICE_ID = "service_bax2r5x";
const EMAILJS_TEMPLATE_ID_ADMIN = "template_i93f9pw";
const EMAILJS_TEMPLATE_ID_AUTOREPLY = "template_cf6tdsf";
const EMAILJS_PUBLIC_KEY = "cxR8z_bsDuZ9e8_Pj";
				...
				<Container>
					...
					>
						...
						<p className="mt-4 max-w-xl text-[15px] leading-relaxed text-ink-dim sm:text-base">
							Questions about a service or which division fits your need? Send a
							message and an advisor will respond.
						</p>
					</div>
				</Container>
			</div>
